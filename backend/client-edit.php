...
$check = "SELECT * FROM clients where ClientID = '$s_id'";
...
<?php
 while($row = mysqli_fetch_assoc($result1)){
  ...
  <input type="hidden" class="form-control" name="id" value = "<?php echo $row['ClientID']; ?>" required>
    <label >Name</label>
...
if(isset($_POST['upd'])){
    ...
    $conn = mysqli_connect('localhost' , 'root' , '' , 'lawyers') or die ('Connect Failed');
    echo $check = "update clients set Name = '{$c_name}' , Email = '{$c_email}', City = '{$c_city}' , Contact = '{$c_contact}' , Gender = '{$c_gender}' where ClientID = '{$s_id}' ";
