  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="page-section"> <span class="page-text">Book Your Appointment</span>
...
<?php
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="client_contact"   required>
  </div>
  
  <div class="form-group">
    <label >Calendar</label>
    <input type="date" id="a" name = "cal" class="form-control" min = "12-02-2020"   required >
  </div>
...
if(isset($_POST['sbt'])){
        ...
        $check1 = "select * from test where lawyer_name = '{$l_name}' AND date = '{$cal}'";
        $result_c = mysqli_query($conn , $check1);
        $num = mysqli_num_rows($result_c);
        if($num == 0)
        {
            $sql = "INSERT INTO test(lawyer_name , customer_name , date) VALUES ('{$l_name}' , '{$c_name}' , '{$cal}')";
