          ...
          <div class="navigation-wrapper">
            <div id="navigation">
              <ul>
                ...
                <li class=""><a href="practice.php" title="practice Area">Practise Area</a>
                ...
                <li><a href="lawyer.php" title="OurLawyer">Our Lawyers</a></li>
                 ...
                 <li class="has-sub"><a href="Contact.php" title="Contact Us">Login</a>
                  <ul>
                    <li><a href="client-login.php" title="Client Login">Client Login</a></li>
                    <li><a href="client-regist.php" title="Client Registeration">Client Registration</a></li>
                  </ul>

                 <li><a href="lawyer-register.php" title="About us"> Registration</a> </li>
              </ul>
            </div>
          </div>
        </div>
